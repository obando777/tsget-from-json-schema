...
export interface ApplicationFormUIDocument {
  data: ApplicationFormUI;
}
export interface ApplicationFormUI {
  ...
  attributes: {
    ...
    bankName?: string;
    status?: "Entering" | "AwaitingDocuments" | "PendingReview" | "Approved" | "Denied" | "Pending" | "Canceled";
    state?: {
      [k: string]: unknown;
    };
