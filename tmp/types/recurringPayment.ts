...
export type RecurringPaymentResource1 = RecurringCreditACHPayment | RecurringCreditBookPayment;

export interface RecurringPaymentResource {
  data: RecurringPaymentResource1;
}
